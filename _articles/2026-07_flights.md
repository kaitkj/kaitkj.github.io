...
Over the past four years, I've made more than ten trips to Shanghai and worked on over fifty embedded hardware product projects.

Like many engineers, I thought I was travelling there to learn how to build better products. I didn't expect it to change the way I think about people, culture, and collaboration.

## Great Products are Built by Great Teams

I've always been excited to visit Espressif's headquarters, the birthplace of the ESP32. There was something incredibly rewarding about working alongside the people behind the chips, open-source software solutions, and development frameworks that power millions of devices around the world. When an idea comes up during a discussion, the people designing the silicon, building the software stack, and developing applications are often just a few desks away. The feedback loop is remarkably short, making it possible to build more interesting products and experiences for customers.

It taught me my first lesson: great products aren't built by individuals. They're built by great teams.

Working on hardware products has also taught me that speaking the same language doesn't always mean understanding one another.

## Same Language, Not Same Culture

Although I come from a Chinese-speaking family, I quickly realised that technical Chinese was an entirely different language. There were unfamiliar engineering terms, colloquial expressions unique to Mainland China, and conversations that seemed to happen at twice the speed I was used to. More than once, I found myself silently translating what I had just heard before attempting to contribute to the discussion.

Over time, I learnt that communication is far more than vocabulary. It's about understanding how people think, explain ideas, disagree respectfully, and arrive at decisions together. Adapting my communication style became just as important as improving my technical knowledge.

Perhaps one of the biggest surprises for me had nothing to do with engineering at all.

Coming from Singapore, I didn't realise how fortunate I was to be able to live close to my family while pursuing a meaningful career. Many of my colleagues came from all parts of the country, some travelling home only after taking domestic flights despite how extensive the high-speed rail network has become. It made me realise that urban migration isn't unique to one country. We see it happen across large economies all over the world.

As people leave their hometowns for opportunities elsewhere, they also leave behind their families, social circles, and support systems. Naturally, colleagues become much more than people you work with. Weekend gatherings are common. Some colleagues live in the same apartment complexes, while others share accommodation together. The boundaries between work and life are often much more fluid than I was used to in Singapore.

What began as colleagues eventually became friendships outside of work.
...
Engineering may connect devices, but it's people that connect ideas. Building great products starts with understanding both.
